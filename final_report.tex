...
The report is organized by question, with each section containing the problem statement, solution methodology, results, and discussion.


\section{Problem Statements}
\begin{enumerate}
    \item[1.] Design a NPDA for $L = \{ a^n b^n | n \ge 1 \}$
    \item[2.] Construct DFA for $L = \{ a b^n a^m : n \ge 2, m \ge 3 \}$
    \item[3.] DFA for strings ending with '0011', $\Sigma = \{0,1\}$
    \item[4.] NPDA for $L = \{ a^n b^m c^{n+m} \}$
    \item[5.] Minimal DFA where 'a' is never followed by 'bb'
...
\newpage
\section{Solutions}
\subsection{Question 1: Design a NPDA for $L = \{ a^n b^n | n \ge 1 \}$}
...
\clearpage
\subsection{Question 2: Construct DFA for $L = \{ a b^n a^m : n \ge 2, m \ge 3 \}$}
\subsubsection{Methodology}
1. Open JFLAP.
...
\clearpage
\subsection{Question 3: DFA for strings ending with '0011', $\Sigma = \{0,1\}$}
\subsubsection{Methodology}
1. Open JFLAP.
2. Click on \textbf{Finite Automaton}.
3. \textbf{Add States}:
...
\clearpage
\subsection{Question 4: NPDA for $L = \{ a^n b^m c^{n+m} \}$}
\subsubsection{Methodology}
1. Open JFLAP.
2. Click on \textbf{Pushdown Automaton}.
3. \textbf{Add States}:
...
\clearpage
\subsection{Question 5: Minimal DFA where 'a' is never followed by 'bb'}
\subsubsection{Methodology}
1. Open JFLAP.
2. Click on \textbf{Finite Automaton}.
3. \textbf{Add States}:
...
\clearpage
\subsection{Question 12: NFA for $\{ab, abc\}^*$}
\subsubsection{Methodology}
1. Open JFLAP.
2. Click on \textbf{Finite Automaton}.
3. \textbf{Add States}:
...
\clearpage
\subsection{Question 13: DFA for strings ending with 'abb'}
\subsubsection{Methodology}
1. Open JFLAP.
2. Click on \textbf{Finite Automaton}.
3. \textbf{Add States}:
...
\clearpage
\subsection{Question 14: DFA for strings ending with 'abba'}
\subsubsection{Methodology}
1. Open JFLAP.
2. Click on \textbf{Finite Automaton}.
3. \textbf{Add States}:
...
\clearpage
\subsection{Question 15: DFA/NFA for strings containing ``the''}
\subsubsection{Methodology}
1. Open JFLAP.
2. Click on \textbf{Finite Automaton}.
3. \textbf{Add States}:
...
\clearpage
\subsection{Question 16: DFA/NFA for strings ending with ``ing''}
\subsubsection{Methodology}
1. Open JFLAP.
2. Click on \textbf{Finite Automaton}.
3. \textbf{Add States}:
...
\clearpage
\subsection{Question 29: TM accepting palindromes over $\{a,b\}$}
\subsubsection{Methodology}
1. Open JFLAP.
...
\clearpage
\subsection{Question 30: TM accepting $\{ w w^R \}$}
\subsubsection{Methodology}
1. Open JFLAP.
2. Click on \textbf{Turing Machine} (Single Tape).
3. \textbf{Add States}:
...
\clearpage
\subsection{Question 24: TM accepting $\{ 0^n 1^n \}$}
\subsubsection{Methodology}
1. Open JFLAP.
2. Click on \textbf{Turing Machine} (Single Tape).
3. \textbf{Add States}:
...
\clearpage
\subsection{Question 25: TM accepting $\{ 0^n 1^n 2^n \}$}
\subsubsection{Methodology}
1. Open JFLAP.
2. Click on \textbf{Turing Machine} (Single Tape).
3. \textbf{Add States}:
...
\clearpage
\subsection{Question 26: TM for strings containing substring 001}
\subsubsection{Methodology}
1. Open JFLAP.
2. Click on \textbf{Turing Machine} (Single Tape).
3. \textbf{Add States}:
